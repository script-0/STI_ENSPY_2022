...
\subsubsectionautorefname{Modes d'interaction}
...
Après la modélisation du domaine d'application, nous présentons ici la modélisation de l'apprenant dans PartientVirtuel.
